$(document).ready(function() {
    ...
    let arrayDescription = ["El Gato con Botas es un personaje astuto y valiente de cuentos de hadas, conocido por su habilidad para resolver problemas y su destreza en la caza de ratones. Siempre lleva botas y un sombrero con plumas, y es famoso por su ingenio y astucia.",
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 350px; height: 700px;">
                    <div class="card-body">
                        ...
                        <hr>
                        <a href="movie_detail.html?id=${movie.id} class="btn btn-primary stretched-link" >Ver Detalles</a>
                    </div>
                </div>
            </div>`);
        });
